...
#ifndef DYNORB_INTERFACE__SRV__DETAIL__DYN_CLASS__FUNCTIONS_H_
#define DYNORB_INTERFACE__SRV__DETAIL__DYN_CLASS__FUNCTIONS_H_
...
/// Initialize srv/DynClass message.
/**
...
/// Create srv/DynClass message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dynorb_interface__srv__DynClass_Request__init().
...
/// Destroy srv/DynClass message.
/**
 * It calls
 * dynorb_interface__srv__DynClass_Request__fini()
...
/// Check for srv/DynClass message equality.
/**
...
/// Initialize array of srv/DynClass messages.
/**
...
/// Finalize array of srv/DynClass messages.
/**
 * It calls
 * dynorb_interface__srv__DynClass_Request__fini()
...
/// Create array of srv/DynClass messages.
/**
 * It allocates the memory for the array and calls
 * dynorb_interface__srv__DynClass_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/DynClass messages.
/**
 * It calls
 * dynorb_interface__srv__DynClass_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/DynClass message array equality.
/**
...
/// Copy an array of srv/DynClass messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dynorb_interface__srv__DynClass_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dynorb_interface
...
/**
 * It calls
 * dynorb_interface__srv__DynClass_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_dynorb_interface
...
/**
 * It allocates the memory for the array and calls
 * dynorb_interface__srv__DynClass_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dynorb_interface
...
/**
 * It calls
 * dynorb_interface__srv__DynClass_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DYNORB_INTERFACE__SRV__DETAIL__DYN_CLASS__FUNCTIONS_H_
