...
static const _DynClass_Request_type_support_symbol_names_t _DynClass_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynorb_interface, srv, DynClass_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dynorb_interface, srv, DynClass_Request)),
  }
};
...
{
  return &::dynorb_interface::srv::rosidl_typesupport_cpp::DynClass_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dynorb_interface, srv, DynClass_Request)() {
  return get_message_type_support_handle<dynorb_interface::srv::DynClass_Request>();
}
...
static const _DynClass_Response_type_support_symbol_names_t _DynClass_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynorb_interface, srv, DynClass_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dynorb_interface, srv, DynClass_Response)),
  }
};
...
{
  return &::dynorb_interface::srv::rosidl_typesupport_cpp::DynClass_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dynorb_interface, srv, DynClass_Response)() {
  return get_message_type_support_handle<dynorb_interface::srv::DynClass_Response>();
}
...
static const _DynClass_type_support_symbol_names_t _DynClass_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynorb_interface, srv, DynClass)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dynorb_interface, srv, DynClass)),
  }
};
...
{
  return &::dynorb_interface::srv::rosidl_typesupport_cpp::DynClass_service_type_support_handle;
}
